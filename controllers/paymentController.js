...
exports.submitPaymentRequest = async (req, res) => {
  ...
  try {
    ...
    if (existingPayment) {
      return res.status(400).json({ message: 'මෙම මාසය සඳහා ගෙවීම් ඉල්ලීමක් දැනටමත් පවතී (බොහෝ දුරට ප්‍රතික්ෂේප වූ එකක්). කරුණාකර එය ඔබේ Student Dashboard එකෙහි ⤵️ යට ම ඇති ➡️ Quick Actions ➡️ "මගේ ගෙවීම් ඉල්ලීම්" පිටුව පරීක්ශා කර බලා, එය ඉවත් කර 🗑️ නැවත උත්සාහ කරන්න. නැතහොත් අපගේ කාර්‍යමණ්ඩලය සම්භන්ධ කර ගන්න.' });
    }
